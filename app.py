...
def auto_run_sorteo():
    try:
        ...
        sorteo_time = tz.localize(datetime(2025, 12, 16, 14, 15, 0))
...
def show_register():
    ...
    # FECHA LÍMITE GLOBAL (Diversión): 16 de Diciembre 14:10
    end_date_global = tz.localize(datetime(2025, 12, 16, 14, 10, 0))
    ...
    with col2:
        ...
        <div style="background: rgba(255, 255, 255, 0.95); padding: 2.5rem; border-radius: 16px; 
            ...
            <ul style="color: #4b5563; line-height: 2; font-size: 0.95rem; margin-left: 1.5rem;">
                <li>✨ <strong>Registro:</strong> Del 04 de diciembre al 16 de diciembre, 14:10 hrs (GMT-5)</li>
                <li>🎲 <strong>Sorteo:</strong> Se realizará el 16 de diciembre a las 14:10 hrs (GMT-5)</li>
...
def show_register():
    ...
    start_date = tz.localize(datetime(2025, 12, 4, 0, 0, 0))
    end_date = tz.localize(datetime(2025, 12, 16, 14, 10, 0))  # 16 dic 2025, 14:10 GMT-5
    now_utc = datetime.now(pytz.utc)
    current_date = now_utc.astimezone(tz)
        ...
        if not is_open:
            ...
            <div style="background: rgba(255, 255, 255, 0.95); padding: 3rem; border-radius: 16px; 
                ...
                <p style="color: #4b5563; font-size: 1.1rem;">
                    Las inscripciones solo están disponibles del 04 de diciembre al 16 de diciembre, 14:10 hrs (GMT-5).
                </p>
                <p style="color: #6b7280; margin-top: 1rem;">
